...
// configuration step. It creates a namespace called `quickBEM`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", quickBEM::cmake::project_name, quickBEM::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", quickBEM::cmake::project_version);
      return EXIT_SUCCESS;
    }
